...
func init() {
	...
	DefineInstruction(0xC0, "RET NZ", func(c *CPU) { c.s.Tick(4); c.retConditional(!c.isFlagSet(FlagZero)) })
	...
	DefineInstruction(0xC8, "RET Z", func(c *CPU) { c.s.Tick(4); c.retConditional(c.isFlagSet(FlagZero)) })
	...
	DefineInstruction(0xD0, "RET NC", func(c *CPU) { c.s.Tick(4); c.retConditional(!c.isFlagSet(FlagCarry)) })
	...
	DefineInstruction(0xD8, "RET C", func(c *CPU) { c.s.Tick(4); c.retConditional(c.isFlagSet(FlagCarry)) })
